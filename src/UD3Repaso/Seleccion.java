    ...
    public void modificarSeleccion() {
        try {
            ...
            if (rs.next()) { // SI EL RESULTADO NO ES NULO, ES DECIR, LA SELECCIÓN ESTÁ EN LA BASE DE DATOS
                System.out.print("¿Quieres modificar el nombre de la seleccion? S/n "); // PREGUNTAMOS SI QUIERE MODIFICAR ESTE CAMPO
                ...
                System.out.print("¿Quieres modificar el entrenador de la seleccion? S/n "); // PREGUNTAMOS SI QUIERE MODIFICAR ESTE CAMPO
                if (br.readLine().equalsIgnoreCase("s")) { // SI QUIERE 
